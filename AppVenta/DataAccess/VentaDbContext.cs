    ...
    public class VentaDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Categoria>().HasData(
                new Categoria { IdCategoria = 1, Nombre = "Whisky" },
                new Categoria { IdCategoria = 2, Nombre = "Vodka" },
                new Categoria { IdCategoria = 3, Nombre = "Ron" },
                new Categoria { IdCategoria = 4, Nombre = "Cerveza" },
                new Categoria { IdCategoria = 5, Nombre = "Vino" },
                new Categoria { IdCategoria = 6, Nombre = "Ginebra" }
                );
